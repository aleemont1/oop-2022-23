...
import it.unibo.collections.DoubleComparator;
/**
 * 
 */
public final class UseSetWithOrder {
    ...
    public static void main(final String[] s) {
         ...
         * The comparator does not need to deal with the case of Strings which are not parsable as doubles.
         */
        final Set<String> tree = new TreeSet<>(new DoubleComparator());
        /*
