...
class UseConstructors {
    ...
    public static void main(final String[] args) {
        ...
        // immatricolazione 2013
        Student s4 = new Student("Luca","Verdi",1020,2013);
        ...
        // 7) Creare un treno con 300 posti di cui 100 in prima classe 200 in
        // seconda classe
        Train t3 = new Train(100,200);
        // 7) Creare un treno con 500 posti, tutti di seconda classe
        Train t4 = new Train(0,500);
